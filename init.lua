...
This Neovim configuration (`init.lua`) sets up various key mappings, plugins,
and options to enhance the text editing experience in Neovim.
...
require('lazy').setup({
  ...
  -- NOTE: The import below automatically adds your own plugins, configuration, etc from `lua/ge3224/plugins/*.lua`
  --    You can use this folder to prevent any conflicts with this init.lua if you're interested in keeping
  --    up-to-date with whatever is in the kickstart repo.
  { import = 'ge3224.plugins' },
}, {})
